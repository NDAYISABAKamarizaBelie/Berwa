...
<body>
	...
	<div class="content">
		...
		<table border="1">
			<tr>
				<th>ProductCode</th><th>ProductName</th><th>Delete</th><th>Update</th>
			</tr>
			<?php
			...
			<tr>
			    ...
			    <td><button style="background-color: darkred; border-color: darkred;">
			    	<a href="Delete.php?Del=<?php echo $row['ProductCode'];?>"onclick="return confirm('Are Sure You Want to Delete !!!!')">Delete</a>
			        </button>
			    </td>
				<td><button style="background-color: blue; border-color: blue;">
					<a href="update.php?Upd=<?php echo $row['ProductCode'];?>">Update</a>
				    </button>
				</td>
			</tr>
		<?php
